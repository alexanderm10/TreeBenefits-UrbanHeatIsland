...
ftree.df[ftree.df$tile=="h33v09","year"]
# Problematic tiles: 
# -- h07v06: missing 2011
# -- h11v12: missing 2013
...
# 2011
# --------------
path.2011 <- "/Volumes/Morton_SDM/SurfTemp_MODIS_MODA2/processed/2011/hdf_raw/"

fmet.all <- dir(path.2011, ".hdf")
...
# 2012
# --------------
path.met <- "/Volumes/Morton_SDM/SurfTemp_MODIS_MODA2/processed/2012/hdf_raw/"
...
tree.check[!tree.check$Group.1 %in% tile.check$Group.1,]
# 2011 met: h12v05; h18v09m; h07v06
# --------------

# --------------
# 2015
# --------------
path.met <- "/Volumes/Morton_SDM/SurfTemp_MODIS_MODA2/FILES_CONVERT/2015/07-08/"
